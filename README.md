...
```swift
dependencies: [
    .package(url: "https://github.com/ninestar9552/ChaNetworkingSDK.git", from: "2.0.0") // latest compatible 2.x
]
```

`from: "2.0.0"`은 SwiftPM의 semantic versioning 규칙에 따라 최신 2.x 호환 버전을 사용합니다. 최신 릴리즈 번호는 Git tag를 기준으로 확인하세요.
